...
urlpatterns = [
    ...
    path(
        'becas/create_solicitud_aprovechamiento/',
        views.create_solicitud_aprovechamiento,
        name='create_solicitud_aprovechamiento',
    ),
    ...
    path('confirm_email/<uidb64>/<token>/', views.confirm_email_change, name='confirm_email_change'),
